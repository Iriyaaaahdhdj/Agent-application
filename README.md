...
本项目可作为 AI 产品运营 / PMO / 大模型评测方向的项目经历使用。除基础功能外，仓库新增了评测样例、badcase 分类和岗位映射文档，用于展示「AI Chatbot 流程测试、Prompt 调优、数据评估、产品迭代」能力。
...
- `docs/大模型评测报告.md`：沉淀评测方法、结果摘要、badcase 分析和产品化优化建议。
- `docs/PMO岗位项目映射.md`：说明本项目如何对应 AI Chatbot、AI CRM、用户反馈和 PMO 支持类岗位。
